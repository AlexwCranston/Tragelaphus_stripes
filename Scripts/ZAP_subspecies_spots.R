...
glmm.fixed.ZAP_spots_subspecies <- glmmTMB(relative_n_spots ~ TsetsePresencePROB + 
                                       PNV + TabanidActivity + 
...
random.effects.subspecies <- as.data.frame(glmmTMB::ranef(glmm.fixed.ZAP_spots_subspecies))
